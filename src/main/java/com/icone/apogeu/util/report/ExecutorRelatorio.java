package com.icone.apogeu.util.report;
...
public class ExecutorRelatorio {
    ...
    public void execute(JRBeanCollectionDataSource source) throws SQLException {
        try {
            InputStream relatorioStream = this.getClass().getResourceAsStream(this.caminhoRelatorio);

            JasperPrint print = JasperFillManager.fillReport(relatorioStream, this.parametros, source);
